...
# MODIFIED 6/20/2024: CHANGED POINTER AND LENGTH SIZES, COMMENTED OUT PRINT STATEMENTS, REMOVED HARDCODED DICTIONARY SIZE, AND ADDED NOTICE OF ORIGINAL AUTHOR
#! /usr/bin/env python3
